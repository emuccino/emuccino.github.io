...
var prob = function(words) {
	...
	var score1 = Math.exp(bprob-gprob)+4*Math.exp(bprob2-gprob2)+27*Math.exp(bprob3-gprob3);
	var score2 = Math.exp(gprob-bprob)+4*Math.exp(gprob2-bprob2)+27*Math.exp(gprob3-bprob3);
